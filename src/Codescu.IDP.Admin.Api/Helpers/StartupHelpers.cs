...
using Codescu.IDP.Admin.Api.AuditLogging;
using Codescu.IDP.Admin.Api.Configuration;
using Codescu.IDP.Admin.Api.Configuration.ApplicationParts;
using Codescu.IDP.Admin.Api.Configuration.Constants;
using Codescu.IDP.Admin.Api.Helpers.Localization;
...
namespace Codescu.IDP.Admin.Api.Helpers
{
