...
using SendGrid;
using Codescu.IDP.STS.Identity.Configuration;
using Codescu.IDP.STS.Identity.Configuration.ApplicationParts;
using Codescu.IDP.STS.Identity.Configuration.Constants;
using Codescu.IDP.STS.Identity.Configuration.Interfaces;
using Codescu.IDP.STS.Identity.Helpers.Localization;
using Codescu.IDP.STS.Identity.Services;
using System.Linq;
...
namespace Codescu.IDP.STS.Identity.Helpers
{
